        ...
        <div class="grid grid-cols-3 h-full space-x-4 p-2">
            ...
            <div class="col-span-2 flex flex-col items-center justify-start rounded-2xl bg-white px-4 shadow-md border-2 border-gray-200 space-y-2 h-full">
                ...
                <div class="w-full flex flex-row items-center justify-between border-b-2 border-gray-200 py-2.5">
                    ...
                    <div class="flex flex-row items-center justify-end space-x-4">
                        ...
                        <div class="relative w-72 text-black">
                            <label for="status" class="block text-lg font-medium text-gray-700 mb-2">Chọn trạng thái</label>
                            <select id="status" name="status" class="block w-full px-4 py-2 text-lg border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out">
                ...
                <div class="w-full h-[730px] overflow-auto pr-4">
                    ...
                    <h1 id="no-report">@if ($countReview == 0) Không có báo cáo nào cần xét duyệt @endif</h1>
                </div>
                <script>
                    var page = 1;
                    var isLoading = false;
            ...
            <div class="grid grid-rows-5 space-y-4">
                ...
                <div class="row-span-4 flex flex-col items-center justify-between rounded-2xl bg-white px-4 shadow-md border-2 border-gray-200 space-y-2">
                    ...
                    <div class="w-full flex flex-col items-center justify-start space-y-4 px-2">
                        <img id="image-approvalForm" src="https://media0.giphy.com/media/gfO3FcnL8ZK9wVgr6t/200w.gif?cid=6c09b952vgmok2v2iivlcygbxsl4j7h142m3qwl8xrngyzes&ep=v1_gifs_search&rid=200w.gif&ct=g" loading="lazy" alt="Image" class="w-1/2 aspect-square rounded-2xl border-2 border-gray-200 cursor-pointer object-cover">
                        <div class="w-full space-y-1 text-black">
                            <label for="id-approvalForm" class="font-medium">ID</label>
                            <input type="number" name="id-approvalForm" id="id-approvalForm" disabled placeholder="" class="p-2 border-2 border-gray-500 focus:outline-none focus:border-indigo-700 rounded w-full" disabled>
                        </div>
                        <div class="w-full space-y-1 text-black">
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if(response.success)
                                {
                                    ...
                                    $('#image-approvalForm').attr('src', 'https://media0.giphy.com/media/gfO3FcnL8ZK9wVgr6t/200w.gif?cid=6c09b952vgmok2v2iivlcygbxsl4j7h142m3qwl8xrngyzes&ep=v1_gifs_search&rid=200w.gif&ct=g');
                                    $('#id-approvalForm').prop('value', '');
                                    $('#quantity-approvalForm').prop('value', '');
                                    $('#content-approvalForm').prop('value', '');

                                    let count_approval = $('#count-approval').text();
                                    let count_approval_sidebar = $('#count-approval-sidebar').text();
                                    ...
                                    $('#count-approval-sidebar').text(count_approval);
                                }
                            }
                        });
                    }
