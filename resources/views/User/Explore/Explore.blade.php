...
<main class="w-full h-full">
    ...
    <div class="flex items-center justify-center">
        <div class="w-full max-w-2xl px-4 py-4 sm:px-6 sm:py-6 lg:max-w-7xl lg:px-16 mt-2">
            <div class="my-2 columns-1 sm:columns-2 md:columns-3 lg:columns-4 space-y-4" id="main-content"></div>
        </div>
    </div>
</main>
...
<script>
    ...
    function renderPhotos(photos, loadData = false) {
        ...
        photos.forEach(photo => {
            html += `
                <div class="relative group break-inside-avoid-column">
                    <a href="/image/${photo.id}">
                        <img src="${photo.url}" loading="lazy" alt="Image 1" class="w-full h-full object-cover transition-opacity duration-300 group-hover:opacity-15 rounded-2xl">
                    ...
                    <div class="flex items-center justify-between mx-2 mt-4 mb-8">
                        ...
                        <div class="flex items-center justify-end cursor-default space-x-2">
                            <i class="fas fa-heart text-red-500 text-xl hover:text-[#a000ff]"></i>
                            <div class="font-bold -mt-0.5">${photo.likes_count}</div>
                        </div>
                    </div>
                </div>
            `;
