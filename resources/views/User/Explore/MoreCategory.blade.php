...
@section('Body')
    ...
    <main class="w-full h-full" style="margin-bottom:100px">
        ...
        <div class="flex justify-center">
            <a href="{{ route('showexplore') }}" class="text-center w-48 h-14 relative font-sans text-black text-xl font-semibold group">
                    ...
                    <div class="flex flex-col items-center mb-4">
                        ...
                        <ul class="space-y-2">
                            @foreach ($categories as $item)
                                <li><a href="#" class="text-lg font-medium text-gray-700 hover:text-indigo-600">{{ $item->name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                @endforeach
