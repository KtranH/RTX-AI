            ...
            <div class="w-full max-w-2xl px-4 py-4 sm:px-6 sm:py-6 lg:max-w-7xl lg:px-16">
                <form class="grid grid-cols-12 gap-4" id="addimageform" method="POST" action="{{ route("addimage2album",["id" => $Id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="col-span-4 row-span-1 aspect-square relative group">
                        <img id="image-cover" src="/images/image.png" style="border-radius:30px" alt="Image Cover" class="w-full h-full object-cover">
                    ...
                    <div class="col-span-8 row-span-1 p-4 shadow-md"  style="box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 12px;border-radius:20px" >
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="1" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-[#a000ff] focus:!border-[#a000ff] sm:text-sm" placeholder="Nhập mô tả" required></textarea>
                        </div>
                        <div class="mb-4">
