...
<form id="G13" method="POST" enctype="multipart/form-data" action="{{ route("createg13") }}">
    @csrf
    <div class="bg-white">
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-16">
            ...
            <script>
                document.getElementById('create').addEventListener('click', function(event) {
                    ...
                    const formData = new FormData(document.getElementById('G13'));
                    fetch("{{ route('createg13') }}", {
                        method: 'POST',
                        body: formData,
                        headers: {
