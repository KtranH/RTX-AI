...
<form id="G6" method="POST" action="{{ route("createg6") }}">
    @csrf
    <div class="bg-white">
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-16">
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="col-span-full" style="margin-bottom:2%">
                        ...
                        <p class="mt-3 text-sm leading-6 text-gray-400">Chú ý việc mô tả của bạn rất quan trọng. Đối với phần này bạn sẽ không thể tạo ra ảnh con người!</p>
            ...
            <script>
                document.getElementById('create').addEventListener('click', function(event) {
                    ...
                    const formData = new FormData(document.getElementById('G6'));
                    fetch("{{ route('createg6') }}", {
                        method: 'POST',
                        body: formData,
                        headers: {
