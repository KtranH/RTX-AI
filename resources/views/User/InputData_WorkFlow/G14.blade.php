...
<form id="G14" method="POST" enctype="multipart/form-data" action="{{ route("createg14") }}">
    @csrf
    <div class="bg-white">
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-16">
            ...
            <script>
                document.getElementById('create').addEventListener('click', function(event) {
                    ...
                    const formData = new FormData(document.getElementById('G14'));
                    fetch("{{ route('createg14') }}", {
                        method: 'POST',
                        body: formData,
                        headers: {
