...
<form id="G20" method="POST" enctype="multipart/form-data" action="{{ route("createg20") }}">
    @csrf
    <div class="bg-white">
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-16">
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="col-span-full">
                        <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">Ảnh quần áo của bạn:</label>
            ...
            <script>
                document.getElementById('create').addEventListener('click', function(event) {
                    ...
                    const formData = new FormData(document.getElementById('G20'));
                    fetch("{{ route('createg20') }}", {
                        method: 'POST',
                        body: formData,
                        headers: {
