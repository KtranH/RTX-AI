...
<body style="display:flex;flex-wrap:wrap">
  <form class="form_container" style="margin:auto auto auto auto;" method="POST" action="{{ route("newaccount") }}" data-aos="zoom-in-down">
    ...
    <div class="input_container">
      ...
      <input placeholder="Mật khẩu" title="Inpit title" name="input-pass" type="password" class="input_field form-control @error('input-pass') is-invalid @enderror" id="password_field" minlength="6">
    </div> 
    @error('input-pass')
      <div class="text-danger">{{ $message }}</div>
    @enderror
