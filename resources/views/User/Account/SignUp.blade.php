...
<head>
  ...
  img[src="/assets/img/left_login.png"] {
      height: 100vh;
      width: 60%;
      object-fit: cover;
    }
  ...
  img[src="/assets/img/left_signup.png"] {
      height: 100vh;
      width: 60%;
      object-fit: cover;
    }
  ...
  img[src="/assets/img/left_auth.png"] {
    height: 100vh;
    width: 60%;
    object-fit: cover;
  }
...
<body style="display:flex;flex-wrap:wrap">
  <form class="form_container" style="margin:auto auto auto auto;" method="POST" action="{{ route("newaccount") }}" data-aos="zoom-in-down">
    ...
    <div class="input_container">
        ...
        <input placeholder="Trần Văn A" title="Inpit title" name="input-name" type="text" class="input_field" id="email_field" minlength="6">
    </div>
    ...
    <div class="input_container">
      ...
      <input placeholder="name@mail.com" title="Inpit title" name="input-email" type="email" class="input_field" id="email_field">
    </div>
    ...
    <div class="input_container">
      ...
      <input placeholder="Mật khẩu" title="Inpit title" name="input-pass" type="password" class="input_field" id="password_field" minlength="6">
    </div>
    ...
    <div class="input_container">
      ...
      <input placeholder="Nhập lại password" title="Inpit title" name="input-pass2" type="password" class="input_field" id="password_field" minlength="6">
    </div>
