...
<body style="display:flex;flex-wrap:wrap">
  <form class="form_container" style="margin:auto auto auto auto;" novalidate method="POST" action="{{ route("newaccount") }}">
    @csrf
    <div class="logo_container">
      <a href="{{route("showhome")}}">
        <img src="/assets/img/ai-file.gif" alt="" style="with:100%">
      </a>
    </div>
    <div class="title_container">
      <p class="title">Đăng ký tài khoản của bạn</p>
    ...
    <div class="input_container">
        ...
        <input placeholder="Trần Văn A" title="Inpit title" name="input-name" type="text" class="input_field" id="email_field" minlength="6" required>
    </div>
    @if (Session::has("ErrorName"))
       <p style="color: red; width:100%">Tên tài khoản đã tồn tại!</p>
    @endif
    @if (Session::has("EmptyName"))
       <p style="color: red; width:100%">Tên tài khoản không bỏ trống!</p>
    @endif
    <div class="input_container">
      ...
      <input placeholder="name@mail.com" title="Inpit title" name="input-email" type="text" class="input_field" id="email_field" required>
    </div>
    @if (Session::has("ErrorEmail"))
        <p style="color: red; width:100%">Địa chỉ email đã tồn tại!</p>
    @endif
    @if (Session::has("EmptyEmail"))
        <p style="color: red; width:100%">Địa chỉ email không bỏ trống!</p>
    @endif
    <div class="input_container">
      ...
      <input placeholder="Mật khẩu" title="Inpit title" name="input-pass" type="password" class="input_field" id="password_field" minlength="6" required>
    </div>
    ...
    <div class="input_container">
      ...
      <input placeholder="Nhập lại password" title="Inpit title" name="input-pass2" type="password" class="input_field" id="password_field" minlength="6" required>
    </div>
    ...
    <a title="Sign In" href="{{route("loginByGoogle")}}" class="sign-in_ggl" style="display:flex;width:100%">
      <img src="/assets/img/google.png" alt="" style="width:25px">
