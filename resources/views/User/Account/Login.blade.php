...
<body style="display:flex;flex-wrap:wrap">
  ...
  <form class="form_container" style="margin:5% auto auto auto;" novalidate method="POST" action="{{ route("loginaccount") }}">
    @csrf
    ...
    <div class="input_container">
      ...
      <input placeholder="name@mail.com" title="Inpit title" name="input-email" type="text" class="input_field" id="email_field">
    </div>
    @if (Session::has("EmptyEmail"))
        <p style="color: red; width:100%">Vui lòng nhập địa chỉ email!</p>
    @endif
    ...
    @if (Session::has("ErrorAccount"))
        <p style="color: red; width:100%">Email hoặc mật khẩu không hợp lệ!</p>
    @endif
    <p class="note font-bold" style="margin:0 0 0 60% ">Quên mật khẩu?</p>
    ...
    <a title="Login" href="{{route("loginByGoogle")}}" class="sign-in_ggl" style="display:flex;width:100%">
