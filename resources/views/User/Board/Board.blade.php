                ...
                <div class="w-full max-w-2xl px-4 py-4 sm:px-6 sm:py-6 lg:max-w-7xl lg:px-16">
                    ...
                    @if (!$albums)
                        <div class="mt-2 grid grid-cols-12 gap-2">
                            <div class="col-span-3 row-span-1 relative group">
                                <a href="{{ route('createalbum') }}" style="border-radius:30px" class="block aspect-square bg-gray-200 flex items-center justify-center rounded-lg group-hover:bg-[#a000ff] transition-colors duration-300">
                            ...
                            @foreach ($albums as $x)
                                <div class="col-span-3 row-span-1 relative group" >
                                    <a href="{{ route('showalbum', ['id' => $x->id]) }}">
                                        <div class="aspect-square">
                                            <img src="{{ $x->cover_image }}" style="border:4px solid#B197FC; border-radius:30px" alt="Image 1" class="w-full h-full object-cover rounded-lg">
                                        </div>
